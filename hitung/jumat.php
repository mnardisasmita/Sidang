...
<div class="caption"><center>Jadwal Hari Jumat,
Tanggal
<?php
// konek ke db script
include 'konak.php';
...
$rses = $_SESSION["ruang"] ; 
$querytanggal="SELECT * FROM `jadwal` WHERE `tanggal` = '2016-12-30' AND  `ruang` ='$rses' ORDER BY sesi";
$hasilquerytanggal = mysql_query($querytanggal)or die(mysql_error());
$row = mysql_fetch_array($hasilquerytanggal);
if ($row['tanggal'] == '2016-12-30') 
	{
    echo "30 Desember 2016, ";
	}
else
{
