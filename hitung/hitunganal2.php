...
while ($idvar<=15)
{?>		<td ALIGN=CENTER>
		<input type="number" size ="1" name="" min="0" max="4" id="nilai<?php echo $idvar; ?>" onchange="nilaiindex('ntotalindex')"  placeholder="1-4"  tabindex="<?php echo $tabindex; ?>">
		</td>
...
while ($idvar<=35)
{?>		<td ALIGN=CENTER>
		<input type="number" size ="1" name="" min="1" max="4" id="nilai<?php echo $idvar; ?>" onchange="nilaiindex('ntotalindex')"  placeholder="1-4" tabindex="<?php echo $tabindex; ?>">
		</td>
		<td ALIGN=CENTER><p id="n<?php echo $idvar; ?>index"></p></td>
			<td><center>3</center></td>
<?php
...
<script type="text/javascript" src="hitunganal2.js"></script>
