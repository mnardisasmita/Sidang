...
<div class="caption"><center>Jadwal Hari Kamis,
Tanggal
<?php
// konek ke db script
include 'konak.php';
...
$rses = $_SESSION["ruang"] ; 
$querytanggal="SELECT * FROM `jadwal` WHERE `tanggal` = '2017-02-16' AND  `ruang` ='$rses' ORDER BY sesi";
$hasilquerytanggal = mysql_query($querytanggal)or die(mysql_error());
$row = mysql_fetch_array($hasilquerytanggal);
if ($row['tanggal'] == '2017-02-16') 
	{
    echo "16 Februari 2017, ";
	}
else
{
